! function(e) {
        ...
        function(t, a, s, o) {
            ...
            e(this).each((function() {
                ...
                if (s.on("click", (function(t) {
                    ...
                    s.each((function() {
                        var s = e(this);
                        s.attr("data-slide-go-to", i), i++, s.hasClass("active") && e(n).slick("slickGoTo", s.data("slide-go-to")), e(n).on("beforeChange", (function(e, s, o, n) {
                            t.find(a.tabButton + '[data-slide-go-to="' + n + '"]').addClass("active").siblings().removeClass("active"), r()
                        }))
                    }))
                }
                ...
                function r() {
                    ...
                    o.get(0).style.setProperty("--height-set", i), o.get(0).style.setProperty("--width-set", r), o.get(0).style.setProperty("--pos-y", l), o.get(0).style.setProperty("--pos-x", c), e(s).first().position().left == n.position().left ? o.addClass("start").removeClass("center").removeClass("end") : e(s).last().position().left == n.position().left ? o.addClass("end").removeClass("center").removeClass("start") : o.addClass("center").removeClass("start").removeClass("end")
                }
                r()
            }))
            ...
            e(this).each((function() {
                var s, o, n, i, r, l = e(this);
                s = Math.floor(l.height() / 2), o = l.attr(t), n = l.attr(a), i = c(e(n).css("padding-top")), r = c(e(n).css("padding-bottom")), "top-half" === o ? (e(n).css("padding-bottom", r + s + "px"), l.css("margin-top", "-" + s + "px")) : "bottom-half" === o && (e(n).css("padding-top", i + s + "px"), l.css("margin-bottom", "-" + s + "px"))
            }))
        };
    ...
    //         }))
    //     }, e(".shape-mockup") && e(".shape-mockup").shapeMockup(), window.addEventListener("contextmenu", (function(e) {
    //         e.preventDefault()
    //     }), !1),
